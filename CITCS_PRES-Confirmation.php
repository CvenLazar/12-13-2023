    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                ...
                <form action="user_cand_3.php" method="post" id=ConfirmForm> 
                <table>
                    <tr>
                        <td class="td-1">Candidates Lastname:</td>
					<td class="td-1"><select required name="Lname" required>
            <option>--------Select--------</option>
            <?php 
           $sql = "select lname from candidates where deptid = 1 and position = 'president'";
        ...
        <option><?php echo $output["lname"];?></option>
<?php }?>
			
					</select></td>
                    </tr>
                    <tr>
                        <td class="td-1">Candidates Firstname :</td>
					<td class="td-1"><select required name="Fname" required>
            <option>--------Select--------</option>
            <?php 
           $sql = "select fname from candidates where deptid = 1 and position = 'president'";
        include("dbconnect2.php");
